...
//			#define FS_NO_GLOBALS
	...
	#define FTP_FILE_READ ((uint8_t)FILE_READ)
	#define FTP_FILE_READ_ONLY ((uint8_t)FILE_READ)
#ifdef ESP32
	#define FTP_FILE_READ_WRITE ((uint8_t)FILE_WRITE)
	#define FTP_FILE_WRITE_APPEND ((uint8_t)FILE_APPEND)
#else
	#define FTP_FILE_READ_WRITE ((uint8_t)FILE_WRITE)
	#define FTP_FILE_WRITE_APPEND ((uint8_t)FILE_WRITE)
#endif
	#define FTP_FILE_WRITE_CREATE ((uint8_t)FILE_WRITE)
